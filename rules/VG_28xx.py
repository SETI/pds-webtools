...
opus_products = translator.TranslatorByRegex([
    ...
    (r'.*/VG_28xx/(VG_28..)/S_RINGS/EASYDATA/KM0.*/RS1P2(S|X).*\..*', 0,
...
opus_id = translator.TranslatorByRegex([
    ...
    # VG_2803
    # S RIGNS (1980-11-13, egress): 'mission'-'instrument'-'year'-'day of year'-'band name'-'direction'
    ...
    (r'.*/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM0.*/RU.*2(S|X)6(I|E)\..*', 0, r'vg-rss-occ-1986-24-#LOWER#\1-six-\2'),
    (r'.*/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM0.*/RU.*2(S|X)5(I|E)\..*', 0, r'vg-rss-occ-1986-24-#LOWER#\1-five-\2'),
    (r'.*/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM0.*/RU.*2(S|X)4(I|E)\..*', 0, r'vg-rss-occ-1986-24-#LOWER#\1-four-\2'),
    (r'.*/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM0.*/RU.*2(S|X)A(I|E)\..*', 0, r'vg-rss-occ-1986-24-#LOWER#\1-alpha-\2'),
    (r'.*/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM0.*/RU.*2(S|X)B(I|E)\..*', 0, r'vg-rss-occ-1986-24-#LOWER#\1-beta-\2'),
    (r'.*/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM0.*/RU.*2(S|X)N(I|E)\..*', 0, r'vg-rss-occ-1986-24-#LOWER#\1-eta-\2'),
    (r'.*/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM0.*/RU.*2(S|X)G(I|E)\..*', 0, r'vg-rss-occ-1986-24-#LOWER#\1-gamma-\2'),
    (r'.*/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM0.*/RU.*2(S|X)D(I|E)\..*', 0, r'vg-rss-occ-1986-24-#LOWER#\1-delta-\2'),
    (r'.*/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM0.*/RU.*2(S|X)L(I|E)\..*', 0, r'vg-rss-occ-1986-24-#LOWER#\1-lambda-\2'),
    (r'.*/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM0.*/RU.*2(S|X)E(I|E)\..*', 0, r'vg-rss-occ-1986-24-#LOWER#\1-epsilon-\2'),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('volumes/VG_28xx/VG_2803/S_RINGS/EASYDATA/KM002_5/RS3P2S.TAB',
            {('Voyager RSS',
              50,
              'vgrss_occ_02_5',
              'Occultation Profile (5 km)',
              True): ['volumes/VG_28xx/VG_2803/S_RINGS/EASYDATA/KM002_5/RS3P2S.TAB',
                      'volumes/VG_28xx/VG_2803/S_RINGS/EASYDATA/KM002_5/RS3P2S.LBL'],
             ('Voyager RSS',
              60,
              'vgrss_occ_05',
              'Occultation Profile (10 km)',
              True): ['volumes/VG_28xx/VG_2803/S_RINGS/EASYDATA/KM005/RS3P2S.TAB',
                      'volumes/VG_28xx/VG_2803/S_RINGS/EASYDATA/KM005/RS3P2S.LBL'],
             ('Voyager RSS',
              70,
              'vgrss_occ_10',
              'Occultation Profile (20 km)',
              True): ['volumes/VG_28xx/VG_2803/S_RINGS/EASYDATA/KM010/RS3P2S.TAB',
                      'volumes/VG_28xx/VG_2803/S_RINGS/EASYDATA/KM010/RS3P2S.LBL'],
             ('metadata',
              5,
              'rms_index',
              'RMS Node Augmented Index',
        ...
        ('volumes/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM00_2/RU1P2X4I.TAB',
            {('Voyager RSS',
             ...
             ('Voyager RSS',
              ...
              'vgrss_occ_0_05',
              'Occultation Profile (0.1 km)',
              True): ['volumes/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM00_05/RU1P2X4I.TAB',
                      'volumes/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM00_05/RU1P2X4I.LBL'],
             ('Voyager RSS',
              30,
              'vgrss_occ_0_1',
              'Occultation Profile (0.2 km)',
              True): ['volumes/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM00_1/RU1P2X4I.TAB',
                      'volumes/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM00_1/RU1P2X4I.LBL'],
             ('Voyager RSS',
              40,
              'vgrss_occ_0_2',
              'Occultation Profile (0.4 km)',
              True): ['volumes/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM00_2/RU1P2X4I.TAB',
                      'volumes/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM00_2/RU1P2X4I.LBL'],
             ('Voyager RSS',
              60,
              'vgrss_occ_0_5',
              'Occultation Profile (1 km)',
              True): ['volumes/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM00_5/RU1P2X4I.TAB',
               'volumes/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM00_5/RU1P2X4I.LBL'],
             ('Voyager RSS',
              50,
              'vgrss_occ_0_25',
              'Occultation Profile (0.5 km)',
              True): ['volumes/VG_28xx/VG_2803/U_RINGS/EASYDATA/KM00_25/RU1P2X4I.TAB',
