...
OPUS_TYPE = translator.TranslatorByRegex([
    ...
    (r'metadata/.*profile_index\..*',                 0, ('metadata',  9, 'profile_index',      'Profile Index',                False)),
    (r'metadata/.*supplemental_index\..*',            0, ('metadata', 10, 'supplemental_index', 'Supplemental Index',           False)),
])
